  ...
  create_vpn_connection_tmp = [
    for vpn_key, vpn_config in var.vpn_parameters :
    {
      "${vpn_key}" = {
        ...
        vpn_connection_transport_transit_gateway_attachment_id = try(vpn_config.vpn_connection.transport_transit_gateway_attachment_id, null)
        ...
        vpn_connection_enable_acceleration                     = try(vpn_config.vpn_connection.enable_acceleration, false)
        vpn_connection_local_ipv4_network_cidr                 = try(vpn_config.vpn_connection.local_ipv4_network_cidr, "0.0.0.0/0")
        vpn_connection_local_ipv6_network_cidr                 = try(vpn_config.vpn_connection.local_ipv6_network_cidr, null)
        vpn_connection_outside_ip_address_type                 = try(vpn_config.vpn_connection.outside_ip_address_type, "PublicIpv4")
        vpn_connection_remote_ipv4_network_cidr                = try(vpn_config.vpn_connection.remote_ipv4_network_cidr, "0.0.0.0/0")
        vpn_connection_remote_ipv6_network_cidr                = try(vpn_config.vpn_connection.remote_ipv6_network_cidr, null)
        vpn_connection_tunnel_inside_ip_version                = try(vpn_config.vpn_connection.tunnel_inside_ip_version, "ipv4")
        ...
        vpn_connection_tunnel1_dpd_timeout_seconds             = try(vpn_config.vpn_connection.tunnel1_dpd_timeout_seconds, "30")
        ...
        vpn_connection_tunnel1_inside_ipv6_cidr                = try(vpn_config.vpn_connection.tunnel1_inside_ipv6_cidr, null)
        vpn_connection_tunnel1_enable_tunnel_lifecycle_control = try(vpn_config.vpn_connection.tunnel1_enable_tunnel_lifecycle_control, false)
        vpn_connection_tunnel1_rekey_fuzz_percentage           = try(vpn_config.vpn_connection.tunnel1_rekey_fuzz_percentage, 100)
        vpn_connection_tunnel1_replay_window_size              = try(vpn_config.vpn_connection.tunnel1_replay_window_size, 1024)
        vpn_connection_tunnel1_rekey_margin_time_seconds       = try(vpn_config.vpn_connection.tunnel1_rekey_margin_time_seconds, 270)
        ...
        vpn_connection_tunnel2_dpd_timeout_seconds             = try(vpn_config.vpn_connection.tunnel2_dpd_timeout_seconds, "30")
        ...
        vpn_connection_tunnel2_inside_ipv6_cidr                = try(vpn_config.vpn_connection.tunnel2_inside_ipv6_cidr, null)
        vpn_connection_tunnel2_enable_tunnel_lifecycle_control = try(vpn_config.vpn_connection.tunnel2_enable_tunnel_lifecycle_control, false)
        vpn_connection_tunnel2_rekey_fuzz_percentage           = try(vpn_config.vpn_connection.tunnel2_rekey_fuzz_percentage, 100)
        vpn_connection_tunnel2_replay_window_size              = try(vpn_config.vpn_connection.tunnel2_replay_window_size, 1024)
        vpn_connection_tunnel2_rekey_margin_time_seconds       = try(vpn_config.vpn_connection.tunnel2_rekey_margin_time_seconds, 270)
...
module "vpn" {
  ...
  vpn_connection_tunnel1_inside_ipv6_cidr                = each.value.vpn_connection_tunnel1_inside_ipv6_cidr
  vpn_connection_tunnel1_enable_tunnel_lifecycle_control = each.value.vpn_connection_tunnel1_enable_tunnel_lifecycle_control
  vpn_connection_tunnel1_rekey_fuzz_percentage           = each.value.vpn_connection_tunnel1_rekey_fuzz_percentage
  vpn_connection_tunnel1_replay_window_size              = each.value.vpn_connection_tunnel1_replay_window_size
  vpn_connection_tunnel1_rekey_margin_time_seconds       = each.value.vpn_connection_tunnel1_rekey_margin_time_seconds
  ...
  vpn_connection_tunnel2_dpd_timeout_seconds             = each.value.vpn_connection_tunnel2_dpd_timeout_seconds
  ...
  vpn_connection_tunnel2_inside_ipv6_cidr                = each.value.vpn_connection_tunnel2_inside_ipv6_cidr
  vpn_connection_tunnel2_enable_tunnel_lifecycle_control = each.value.vpn_connection_tunnel2_enable_tunnel_lifecycle_control
  vpn_connection_tunnel2_rekey_fuzz_percentage           = each.value.vpn_connection_tunnel2_rekey_fuzz_percentage
  vpn_connection_tunnel2_replay_window_size              = each.value.vpn_connection_tunnel2_replay_window_size
  vpn_connection_tunnel2_rekey_margin_time_seconds       = each.value.vpn_connection_tunnel2_rekey_margin_time_seconds
