/*----------------------------------------------------------------------*/
/* Customer Gateway | Variable Definition                               */
/*----------------------------------------------------------------------*/
variable "customer_gateway_id" {
  type        = string
  description = "The id of an already created Customer Gateway's. Set value to not create the Customer Gateway"
  default     = null
}
...
/*----------------------------------------------------------------------*/
/* Virtual Private Gateway | Variable Definition                        */
/*----------------------------------------------------------------------*/
variable "virtual_private_gateway_id" {
  type        = string
  description = "The id of an already created Virtual Private Gateway resrouce. Set value to not create the Virtual Private Gateway"
  default     = null
}
...
/*----------------------------------------------------------------------*/
/* VPN Connection | Variable Definition                                 */
/*----------------------------------------------------------------------*/
variable "create_vpn_connection" {
  type        = bool
  description = "If set to `true`, the VPN connection will be created."
  default     = false
}
...
/*----------------------------------------------------------------------*/
/* Transit Gateway | Variable Definition                                */
/*----------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------*/
/* Route Association | Variable Definition                              */
/*----------------------------------------------------------------------*/
